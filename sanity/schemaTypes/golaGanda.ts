...
export const golaGanda = defineType({
  name: 'golaGanda',
  title: 'Gola Ganda',
  type: 'document',
  icon: () => '🍧',
  fields: [
    ...
    defineField({
      name: 'flavor', title: 'Flavor', type: 'string',
      options: { list: ['Mixed Fruit', 'Lemon', 'Orange', 'Strawberry', 'Mango', 'Rose', 'Special Mix'] },
    }),
    ...
    defineField({
      ...
      of: [{
        type: 'object',
        fields: [
          defineField({ name: 'sizeName', title: 'Size', type: 'string', options: { list: ['Regular', 'Large', 'Special'] } }),
  ...
  preview: {
    select: { title: 'title', subtitle: 'flavor', media: 'images.0' },
  },
})
